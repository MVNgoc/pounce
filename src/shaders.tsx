...
export const fragmentShader = `
  ...
  // ========================================================================
  // BẮT ĐẦU MÃ NGUỒN CỦA HÀM SNOISE (SIMPLEX NOISE)
  // Phần code này cần thiết để tạo ra hiệu ứng gợn sóng tự nhiên
  // ========================================================================
  ...
  // ========================================================================
  // KẾT THÚC MÃ NGUỒN CỦA HÀM SNOISE
  // ========================================================================

  void main() {
    // --- LOGIC TÍNH KHOẢNG CÁCH CHO HÌNH GIỌT NƯỚC NẰM NGANG ---
    vec2 p = vUv - u_mouse;
    p.y *= 1.0 + p.x * u_pointiness;
    float dist = length(p) - u_radius;
    
    // --- LOGIC TẠO HIỆU ỨNG VIỀN VÀ TÂM ---
